...
var HTMLheaderRole = '<p id="header_role">%data%</p><hr>';
...
var HTMLskillsKorStart = '<h3 id="skills-h3">기술들:</h3><ul id="skills" class="flex-column"></ul>';
var HTMLskillsJapnStart = '<h3 id="skills-h3">Skills:</h3><ul id="skills" class="flex-column"></ul>';
...
var HTMLprojectImage = '<img class="project_img" src="%data%">';

var HTMLcertificatesStart = '<div class="certificates-entry"></div>';
var HTMLcertificatesTitle = '<a href="#">%data% ';
var HTMLcertificatesIssuedBy = '<span class="issued_by"> -issued by</span><span>%data%</span></a>';
